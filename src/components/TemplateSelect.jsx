...
import TemplateThreeImage from '../images/tempThree.PNG'
  ...
  return (
    <div id='template-select'>
      <div>
        ...
        <p>...switch without losing progress</p>
      </div>
      ...
      <div id='template-icons'>
        ...
        <div id='show-template'>
          ...
          <img id='template-3-large' className='template-large-img' src={TemplateThreeImage} alt='resume template 3 large'/>
